...
<?php if ($post): ?>
    ...
    <a href="<?= get_permalink($post->ID) ?>" class="block w-full aspect-video h-full thumb overflow-hidden relative overlay">
        ...
        <div class="absolute flex gap-2 flex-col bottom-5 left-5 z-10 text-white">
            ...
            <h4 class="uppercase font-bold"><?= $post->post_title ?></h4>
        </div>
    </a>
<?php endif; ?>
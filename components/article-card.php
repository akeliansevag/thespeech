...
<?php if ($post) : ?>
    ...
    <article class="flex flex-col">
        ...
        <div class="flex-1 bg-white shadow-md p-3 border border-[#d9d9d9] border-t-0">
            ...
            <hr class="my-3" />
            <h5 class="text-sm opacity-50">By <a href="<?= get_author_posts_url($post->post_author) ?>"><?= get_the_author_meta('display_name', $post->post_author); ?></a> - <?= get_the_date('M j, Y', $post->ID) ?> </h5>
        </div>
    </article>
<?php endif; ?>